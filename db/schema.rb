...
ActiveRecord::Schema.define(version: 20141112230401) do
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "owner_profile_photo_file_name"
    t.string   "owner_profile_photo_content_type"
    t.integer  "owner_profile_photo_file_size"
    t.datetime "owner_profile_photo_updated_at"
  end
